...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      >
        {/* Logo / Brand Header */}
        <div className={`flex items-center justify-between border-b border-[var(--border-subtle)] ${collapsed && !isMobileOpen ? 'px-3 py-5 justify-center' : 'px-5 py-5'}`}>
          <Link to="/" className="flex flex-col no-underline group" onClick={closeMobile}>
