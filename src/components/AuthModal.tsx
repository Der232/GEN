...
export default function AuthModal({
	...
	}, [open, initialView, initialLinkMode, resetForm]);
						...
						<div className="space-y-2 sm:space-y-3">
							...
							>
								...
								<div className="min-w-0 flex-1">
									...
									<p className="text-[10px] sm:text-[11px] text-[var(--text-secondary)] mt-0.5 leading-relaxed">
										Attach your email to this session. All your created exams,
										completed tests, and scores will be permanently saved.
									</p>
								</div>
							...
							>
								...
								<div className="min-w-0 flex-1">
									...
									<p className="text-[10px] sm:text-[11px] text-[var(--text-secondary)] mt-0.5 leading-relaxed">
										Start clean from scratch without transferring any current
										anonymous exams or practice history.
									</p>
								</div>
								<ArrowRight className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-[var(--text-muted)] group-hover:text-[var(--text-primary)] group-hover:translate-x-0.5 transition-all shrink-0 mt-1.5 sm:mt-2" />
							</button>
