    ...
    <div className="flex flex-col items-center justify-start md:justify-center min-h-[calc(100vh-3.5rem)] px-4 sm:px-6 py-6 sm:py-10 md:py-12 max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="mt-8 sm:mt-12 w-full grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3">
        <div className="gen-card gen-card-hover p-3 sm:px-4 sm:py-3 text-left">
          ...
          <p className="text-[10px] sm:text-[11px] text-[var(--text-secondary)] mt-0.5">Any subject, depth, or topic</p>
        </div>

        <div className="gen-card gen-card-hover p-3 sm:px-4 sm:py-3 text-left">
          <h4 className="text-xs font-semibold text-[var(--text-primary)]">Instant Grading</h4>
          <p className="text-[10px] sm:text-[11px] text-[var(--text-secondary)] mt-0.5">Real-time scoring & feedback</p>
        </div>

        <div className="gen-card gen-card-hover p-3 sm:px-4 sm:py-3 text-left">
          <h4 className="text-xs font-semibold text-[var(--text-primary)]">AI Tutor Explanations</h4>
          <p className="text-[10px] sm:text-[11px] text-[var(--text-secondary)] mt-0.5">Deep-dive on wrong answers</p>
        </div>
      </div>
    </div>
  )
